...
public class MyScrumTeam {
    ...
    public static void main(String[] args) {
        ...
        scrum.addTester(tester1);    // just one tester
        scrum.addDeveloper(developer1);// just one developer

        scrum.addTesters(testers);// add all tester
        scrum.addDevelopers(developers);// add all developer
