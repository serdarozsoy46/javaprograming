...
public class Offer {
    ...
    public String location;  // public String location, companyName,jobTitle;     shortway
    public String companyName;
    public String jobTitle;
    public double salary;
    public boolean hasBenefit;  //public boolean hasBenefit, hasPTO,isWFH,isFullTime;  short way
